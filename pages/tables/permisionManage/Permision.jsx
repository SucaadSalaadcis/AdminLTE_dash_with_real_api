...
import { setPermisionData } from '../../redux/AuthSlice'
        ...
        <div class="hold-transition sidebar-mini">
            <div class="wrapper">
                ...
                <div class="content-wrapper">
                    ...
                    {/* the register btn */}
                    <Link to={'/user-management/permissions/create'}>
                    ...
                    <section class="content">
                        <div class="card-body">
                            ...
                            <Reusible_data_table columns={columns} url={'api/v1/permissions'} dispatchAction={setPermisionData} dataKey="permissions" />
