...
import { setProductData } from '../../redux/AuthSlice'


export default function Products() {

  // Define the columns based on the structure of your data
  const columns = ['id', 'name', 'price', 'commission'];
    ...
    <div class="hold-transition sidebar-mini">
      <div class="wrapper">
        ...
        <div class="content-wrapper">
          ...
          <Content_Header title={'Product'} link={'Home'} />
          ...
          <section class="content">
            <div class="card-body">
              ...
              <Reusible_data_table columns={columns} url={'api/v1/products'} dispatchAction={setProductData} dataKey="products" />
